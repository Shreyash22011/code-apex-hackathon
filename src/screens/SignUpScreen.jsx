  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center items-center relative overflow-hidden p-6">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-24 right-10 w-96 h-96 rounded-full bg-accent/10 blur-3xl opacity-60" />
        <div className="absolute -bottom-28 left-10 w-96 h-96 rounded-full bg-primary/10 blur-3xl opacity-60" />
      </div>
      ...
      <div className="relative z-10 mb-8 text-center animate-fade-in">
        ...
        <p className="text-muted-foreground text-lg">Create a new account</p>
      </div>
